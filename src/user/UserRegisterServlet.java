...
public class UserRegisterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		if(userID == null|| userID.equals("")||userPassword1 == null|| userPassword1.equals("")||userPassword2 == null|| userPassword2.equals("")||userName == null|| userName.equals("")||
				userGender == null|| userGender.equals("")||userAge == null|| userAge.equals("")||phone == null|| phone.equals("")||address == null|| address.equals("")||userEmail == null|| userEmail.equals("")) {
		...
		int result = new UserDAO().register(userID, userPassword1, userName, userGender, userAge, phone, address, userEmail);
		if(result == 1) {
